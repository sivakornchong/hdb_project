...
import pandas as pd
from utils.misc_fn import is_date
...
for mrt in mrt_list:
    try:
        # print(mrt)
        query_string = "https://developers.onemap.sg/commonapi/search?searchVal={}&returnGeom=Y&getAddrDetails=Y&pageNum=1".format(
            mrt
        )
        ...
        labelled_data = {"MRT": mrt, "location": (latitude, longitude)}
